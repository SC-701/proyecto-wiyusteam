        ...
        public async Task<int> Agregar(BautismoRequest bautismo)
        {
            ...
            var resultadoConsulta = await _sqlConnection.ExecuteScalarAsync<int>(
                ...
                new
                {
                    ...
                    AbueloMaterno = bautismo.AbueloMaternoId ,
                    AbuelaMaterna = bautismo.AbuelaMaternaId,
                    AbueloPaterno = bautismo.AbueloPaternoId,
                    AbuelaPaterna = bautismo.AbuelaPaternaId,
